...
public class IDCardValidate {
     ...
     * @param cardNumber
     */
    public IDCardValidate(String cardNumber) {
        if (null != cardNumber) {
    ...
    private static String contertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(IDCardValidate.calculateVerifyCode(buf));
        return buf.toString();
    }
    public static void main(String[] args) {
    	System.out.println(new IDCardValidate("412725198403185079").validate());
	}
}
